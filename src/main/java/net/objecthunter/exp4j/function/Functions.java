...
public class Functions {
    ...
    static {
        builtinFunctions[INDEX_SIN] = new Function<Double, @rad Double>("sin") {
            @Override
            public Double apply(@rad Double... args) {
                return Math.sin(args[0]);
            }
        };
        builtinFunctions[INDEX_COS] = new Function<Double, @rad Double>("cos") {
            @Override
            public Double apply(@rad Double... args) {
                return Math.cos(args[0]);
            }
        };
        builtinFunctions[INDEX_TAN] = new Function<Double, @rad Double>("tan") {
            @Override
            public Double apply(@rad Double... args) {
                return Math.tan(args[0]);
            }
        };
        builtinFunctions[INDEX_COT] = new Function<Double, @rad Double>("cot") {
            @Override
            public Double apply(@rad Double... args) {
        ...
        builtinFunctions[INDEX_ABS] = new Function<@UnknownUnits Double, @UnknownUnits Double>("abs") {
            @Override
            public @PolyUnit Double apply(@PolyUnit Double... args) {
                return Math.abs(args[0]);
            }
        };
        builtinFunctions[INDEX_ACOS] = new Function<@rad Double, @Dimensionless Double>("acos") {
            @Override
            public @rad Double apply(@Dimensionless Double... args) {
                return Math.acos(args[0]);
            }
        };
        builtinFunctions[INDEX_ASIN] = new Function<@rad Double, @Dimensionless Double>("asin") {
            @Override
            public @rad Double apply(@Dimensionless Double... args) {
                return Math.asin(args[0]);
            }
        };
        builtinFunctions[INDEX_ATAN] = new Function<@rad Double, @Dimensionless Double>("atan") {
            @Override
            public @rad Double apply(@Dimensionless Double... args) {
        ...
        builtinFunctions[INDEX_FLOOR] = new Function<@UnknownUnits Double, @UnknownUnits Double>("floor") {
            @Override
            public @PolyUnit Double apply(@PolyUnit Double... args) {
                return Math.floor(args[0]);
            }
        };
        builtinFunctions[INDEX_SINH] = new Function<Double, @rad Double>("sinh") {
            @Override
            public Double apply(@rad Double... args) {
        ...
        builtinFunctions[INDEX_TANH] = new Function<Double, @rad Double>("tanh") {
            @Override
            public Double apply(@rad Double... args) {
                return Math.tanh(args[0]);
            }
        };
        builtinFunctions[INDEX_COSH] = new Function<Double, @rad Double>("cosh") {
            @Override
            public Double apply(@rad Double... args) {
                return Math.cosh(args[0]);
            }
        };
        builtinFunctions[INDEX_CEIL] = new Function<@UnknownUnits Double, @UnknownUnits Double>("ceil") {
            @Override
            public @PolyUnit Double apply(@PolyUnit Double... args) {
